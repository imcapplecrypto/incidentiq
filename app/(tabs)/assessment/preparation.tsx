...
const CATEGORY_ID = 'preparation';

export default function PreparationAssessment() {
  ...
  const [questions, setQuestions] = useState<QuestionData[]>([
    {
      id: 'prep-1',
      question: 'How well-defined are your incident response policies and procedures?',
      selectedLevel: 1,
    },
    {
      id: 'prep-2',
      question: 'How structured and trained is your incident response team?',
      selectedLevel: 1,
    },
    {
      id: 'prep-3',
      question: 'How comprehensive is your incident response plan documentation?',
      selectedLevel: 1,
    },
    {
      id: 'prep-4',
      question: 'How regularly do you conduct incident response training and exercises?',
      selectedLevel: 1,
    },
    {
      id: 'prep-5',
      question: 'How well-integrated are your incident response tools and technologies?',
      selectedLevel: 1,
    },
  ]);
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>Preparation & Planning</Text>
            <Text style={styles.subtitle}>Policies, procedures, and team structure</Text>
          </View>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.questionsContainer}>
          ...
          <Text style={styles.sectionDescription}>
            Rate each area based on your organization's current maturity level using the COBIT framework.
          </Text>
        ...
        <View style={styles.recommendationsContainer}>
          ...
          {score < 60 && (
            <View style={styles.recommendationCard}>
              <Text style={styles.recommendationTitle}>Focus Areas for Improvement</Text>
              <Text style={styles.recommendationText}>
                ...
                • Create detailed documentation and playbooks{'\n'}
                • Implement regular training and tabletop exercises
              </Text>
            </View>
          )}
          {score >= 60 && score < 80 && (
            <View style={styles.recommendationCard}>
              ...
              <Text style={styles.recommendationText}>
                ...
                • Implement advanced training scenarios{'\n'}
                • Integrate automation tools for faster response{'\n'}
          ...
          {score >= 80 && (
            <View style={styles.recommendationCard}>
              <Text style={styles.recommendationTitle}>Optimization Focus</Text>
              <Text style={styles.recommendationText}>
                • Implement predictive analytics for threat detection{'\n'}
                • Develop AI-assisted response capabilities{'\n'}
                • Create industry-leading best practices{'\n'}
